  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch(`${getBaseUrl()}/api/categoriesUa/add-new-category-ua`, {
        ...
        credentials: 'include',
        body: JSON.stringify(categoryUa)
      });
