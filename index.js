...
app.use(cors({
  origin: ["http://localhost:5173", "https://mildo.shop", "http://mildo.shop"],
  credentials: true,
...
const seasonuaRoutes = require('./src/seasonua/seasonsua.route');
const seasonruRoutes = require('./src/seasonru/seasonsru.route');
const seasonenRoutes = require('./src/seasonen/seasonen.route');
...
app.use('/api/seasonua', seasonuaRoutes);
app.use('/api/seasonru', seasonruRoutes);
app.use('/api/seasonen', seasonenRoutes);
